...
def generate_queries_llm(niche, city, site_info=None):
    ...
    prompt = (
        ...
        "Начинай каждый запрос как безличный вопрос: «Какие компании…», «Кто делает…», «Кто продаёт…», «Где заказать…», "
        "«На каком сайте купить…», «В каких магазинах…», «Куда обратиться за…», «Что выбрать, если нужно…». "
        ...
        "СПИСОК КОМПАНИЙ — САМОЕ ВАЖНОЕ: минимум 7 из 10 запросов сформулируй так, чтобы нейросеть в ответ ВЫДАЛА СПИСОК конкретных компаний, "
        "сайтов или магазинов: «Какие компании…», «Кто делает/продаёт…», «Где заказать/купить…», «На каком сайте купить…», "
        "«В каких магазинах…», «В каких компаниях…». По таким запросам видно, кого нейросеть называет, а кого нет — это и есть показательный замер. "
